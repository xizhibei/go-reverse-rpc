...
func (mr *MockMQTTClientAdapterMockRecorder) OffConnect(idx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) OffConnectLost(idx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) OnConnect(cb interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) OnConnectLost(cb interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) OnConnectLostOnce(cb interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) OnConnectOnce(cb interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMQTTClientAdapter) Publish(topic string, qos byte, payload interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) Publish(topic, qos, payload interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMQTTClientAdapter) PublishBytes(topic string, qos byte, retained bool, data []byte) mqtt.Token {
	m.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) PublishBytes(topic, qos, retained, data interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMQTTClientAdapter) PublishWait(topic string, qos byte, payload interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) PublishWait(topic, qos, payload interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMQTTClientAdapter) PublishWaitTimeout(topic string, qos byte, timeout time.Duration, payload interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) PublishWaitTimeout(topic, qos, timeout, payload interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMQTTClientAdapter) Subscribe(topic string, qos byte, onMsg mqtt_adapter.MessageCallback) mqtt.Token {
	m.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) Subscribe(topic, qos, onMsg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMQTTClientAdapter) SubscribeMultiple(filters map[string]byte, onMsg mqtt_adapter.MessageCallback) mqtt.Token {
	m.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) SubscribeMultiple(filters, onMsg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) SubscribeWait(topic, qos, onMsg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMQTTClientAdapterMockRecorder) Unsubscribe(topic interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMQTTClientAdapter) publishObject(topic string, qos byte, payload interface{}) (mqtt.Token, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "publishObject", topic, qos, payload)
	ret0, _ := ret[0].(mqtt.Token)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockMQTTClientAdapterMockRecorder) publishObject(topic, qos, payload interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "publishObject", reflect.TypeOf((*MockMQTTClientAdapter)(nil).publishObject), topic, qos, payload)
}
